...
const LOCALES_DIRS = [
	...
	path.resolve(path.dirname(require.resolve('@collaborne/material-remirror/package.json')), 'locales'),
	path.resolve(path.dirname(require.resolve('@collaborne/material-auth/package.json')), 'locales'),
];
