import{c as Xr,r as $r,u as Gr,e as Zr,j as g,a as K,b as or,g as tr,d as re,f as Nr,h as ar,i as ee,s as N,k as f,B as ne,l as oe,m as Tr,n as nr,C as te,o as ae,p as ie,q as Or,t as er,v as se,w as le,x as ce,P as de,y as me,M as ue,E as qr,z as Fr,A as pe,R as ge,S as he,D as be,F as fe,G as ke,H as ye,I as xe,J as lr,K as ve,U as we,T as ze}from"./useEditorMention-CxUMnx9G.js";import{r as b}from"./iframe-CjSdN0AE.js";import"./index-Dh857mfS.js";import"./preload-helper-PPVm8Dsz.js";const Se=Xr();function Ce(r){const{theme:e,name:n,props:o}=r;return!e||!e.components||!e.components[n]||!e.components[n].defaultProps?o:$r(e.components[n].defaultProps,o)}function Ae({props:r,name:e,defaultTheme:n,themeId:o}){let t=Gr(n);return o&&(t=t[o]||t),Ce({theme:t,name:e,props:r})}function Me(r,e){return b.isValidElement(r)&&e.indexOf(r.type.muiName??r.type?._payload?.value?.muiName)!==-1}const Be=(r,e)=>r.filter(n=>e.includes(n)),O=(r,e,n)=>{const o=r.keys[0];Array.isArray(e)?e.forEach((t,a)=>{n((m,u)=>{a<=r.keys.length-1&&(a===0?Object.assign(m,u):m[r.up(r.keys[a])]=u)},t)}):e&&typeof e=="object"?(Object.keys(e).length>r.keys.length?r.keys:Be(r.keys,Object.keys(e))).forEach(a=>{if(r.keys.includes(a)){const m=e[a];m!==void 0&&n((u,d)=>{o===a?Object.assign(u,d):u[r.up(a)]=d},m)}}):(typeof e=="number"||typeof e=="string")&&n((t,a)=>{Object.assign(t,a)},e)};function Y(r){return`--Grid-${r}Spacing`}function J(r){return`--Grid-parent-${r}Spacing`}const cr="--Grid-columns",T="--Grid-parent-columns",Ee=({theme:r,ownerState:e})=>{const n={};return O(r.breakpoints,e.size,(o,t)=>{let a={};t==="grow"&&(a={flexBasis:0,flexGrow:1,maxWidth:"100%"}),t==="auto"&&(a={flexBasis:"auto",flexGrow:0,flexShrink:0,maxWidth:"none",width:"auto"}),typeof t=="number"&&(a={flexGrow:0,flexBasis:"auto",width:`calc(100% * ${t} / var(${T}) - (var(${T}) - ${t}) * (var(${J("column")}) / var(${T})))`}),o(n,a)}),n},je=({theme:r,ownerState:e})=>{const n={};return O(r.breakpoints,e.offset,(o,t)=>{let a={};t==="auto"&&(a={marginLeft:"auto"}),typeof t=="number"&&(a={marginLeft:t===0?"0px":`calc(100% * ${t} / var(${T}) + var(${J("column")}) * ${t} / var(${T}))`}),o(n,a)}),n},Ie=({theme:r,ownerState:e})=>{if(!e.container)return{};const n={[cr]:12};return O(r.breakpoints,e.columns,(o,t)=>{const a=t??12;o(n,{[cr]:a,"> *":{[T]:a}})}),n},Pe=({theme:r,ownerState:e})=>{if(!e.container)return{};const n={};return O(r.breakpoints,e.rowSpacing,(o,t)=>{const a=typeof t=="string"?t:r.spacing?.(t);o(n,{[Y("row")]:a,"> *":{[J("row")]:a}})}),n},Re=({theme:r,ownerState:e})=>{if(!e.container)return{};const n={};return O(r.breakpoints,e.columnSpacing,(o,t)=>{const a=typeof t=="string"?t:r.spacing?.(t);o(n,{[Y("column")]:a,"> *":{[J("column")]:a}})}),n},Le=({theme:r,ownerState:e})=>{if(!e.container)return{};const n={};return O(r.breakpoints,e.direction,(o,t)=>{o(n,{flexDirection:t})}),n},$e=({ownerState:r})=>({minWidth:0,boxSizing:"border-box",...r.container&&{display:"flex",flexWrap:"wrap",...r.wrap&&r.wrap!=="wrap"&&{flexWrap:r.wrap},gap:`var(${Y("row")}) var(${Y("column")})`}}),Ge=r=>{const e=[];return Object.entries(r).forEach(([n,o])=>{o!==!1&&o!==void 0&&e.push(`grid-${n}-${String(o)}`)}),e},Ne=(r,e="xs")=>{function n(o){return o===void 0?!1:typeof o=="string"&&!Number.isNaN(Number(o))||typeof o=="number"&&o>0}if(n(r))return[`spacing-${e}-${String(r)}`];if(typeof r=="object"&&!Array.isArray(r)){const o=[];return Object.entries(r).forEach(([t,a])=>{n(a)&&o.push(`spacing-${t}-${String(a)}`)}),o}return[]},Te=r=>r===void 0?[]:typeof r=="object"?Object.entries(r).map(([e,n])=>`direction-${e}-${n}`):[`direction-xs-${String(r)}`];function Oe(r,e){r.item!==void 0&&delete r.item,r.zeroMinWidth!==void 0&&delete r.zeroMinWidth,e.keys.forEach(n=>{r[n]!==void 0&&delete r[n]})}const qe=re(),Fe=Se("div",{name:"MuiGrid",slot:"Root"});function We(r){return Ae({props:r,name:"MuiGrid",defaultTheme:qe})}function _e(r={}){const{createStyledComponent:e=Fe,useThemeProps:n=We,useTheme:o=Gr,componentName:t="MuiGrid"}=r,a=(s,i)=>{const{container:l,direction:p,spacing:k,wrap:h,size:w}=s,z={root:["root",l&&"container",h!=="wrap"&&`wrap-xs-${String(h)}`,...Te(p),...Ge(w),...l?Ne(k,i.breakpoints.keys[0]):[]]};return or(z,C=>tr(t,C),{})};function m(s,i,l=()=>!0){const p={};return s===null||(Array.isArray(s)?s.forEach((k,h)=>{k!==null&&l(k)&&i.keys[h]&&(p[i.keys[h]]=k)}):typeof s=="object"?Object.keys(s).forEach(k=>{const h=s[k];h!=null&&l(h)&&(p[k]=h)}):p[i.keys[0]]=s),p}const u=e(Ie,Re,Pe,Ee,Le,$e,je),d=b.forwardRef(function(i,l){const p=o(),k=n(i),h=Zr(k);Oe(h,p.breakpoints);const{className:w,children:z,columns:C=12,container:y=!1,component:L="div",direction:M="row",wrap:$="wrap",size:B={},offset:S={},spacing:A=0,rowSpacing:P=A,columnSpacing:H=A,unstable_level:j=0,...I}=h,E=m(B,p.breakpoints,R=>R!==!1),X=m(S,p.breakpoints),Z=i.columns??(j?void 0:C),rr=i.spacing??(j?void 0:A),Q=i.rowSpacing??i.spacing??(j?void 0:P),Yr=i.columnSpacing??i.spacing??(j?void 0:H),sr={...h,level:j,columns:Z,container:y,direction:M,wrap:$,spacing:rr,rowSpacing:Q,columnSpacing:Yr,size:E,offset:X},Jr=a(sr,p);return g.jsx(u,{ref:l,as:L,ownerState:sr,className:K(Jr.root,w),...I,children:b.Children.map(z,R=>b.isValidElement(R)&&Me(R,["Grid"])&&y&&R.props.container?b.cloneElement(R,{unstable_level:R.props?.unstable_level??j+1}):R)})});return d.muiName="Grid",d}function De(r){return tr("MuiButton",r)}const G=Nr("MuiButton",["root","text","textInherit","textPrimary","textSecondary","textSuccess","textError","textInfo","textWarning","outlined","outlinedInherit","outlinedPrimary","outlinedSecondary","outlinedSuccess","outlinedError","outlinedInfo","outlinedWarning","contained","containedInherit","containedPrimary","containedSecondary","containedSuccess","containedError","containedInfo","containedWarning","disableElevation","focusVisible","disabled","colorInherit","colorPrimary","colorSecondary","colorSuccess","colorError","colorInfo","colorWarning","textSizeSmall","textSizeMedium","textSizeLarge","outlinedSizeSmall","outlinedSizeMedium","outlinedSizeLarge","containedSizeSmall","containedSizeMedium","containedSizeLarge","sizeMedium","sizeSmall","sizeLarge","fullWidth","startIcon","endIcon","icon","iconSizeSmall","iconSizeMedium","iconSizeLarge","loading","loadingWrapper","loadingIconPlaceholder","loadingIndicator","loadingPositionCenter","loadingPositionStart","loadingPositionEnd"]),Wr=b.createContext({}),_r=b.createContext(void 0),Ve=r=>{const{color:e,disableElevation:n,fullWidth:o,size:t,variant:a,loading:m,loadingPosition:u,classes:d}=r,s={root:["root",m&&"loading",a,`${a}${f(e)}`,`size${f(t)}`,`${a}Size${f(t)}`,`color${f(e)}`,n&&"disableElevation",o&&"fullWidth",m&&`loadingPosition${f(u)}`],startIcon:["icon","startIcon",`iconSize${f(t)}`],endIcon:["icon","endIcon",`iconSize${f(t)}`],loadingIndicator:["loadingIndicator"],loadingWrapper:["loadingWrapper"]},i=or(s,De,d);return{...d,...i}},Dr=[{props:{size:"small"},style:{"& > *:nth-of-type(1)":{fontSize:18}}},{props:{size:"medium"},style:{"& > *:nth-of-type(1)":{fontSize:20}}},{props:{size:"large"},style:{"& > *:nth-of-type(1)":{fontSize:22}}}],Ue=N(ne,{shouldForwardProp:r=>oe(r)||r==="classes",name:"MuiButton",slot:"Root",overridesResolver:(r,e)=>{const{ownerState:n}=r;return[e.root,e[n.variant],e[`${n.variant}${f(n.color)}`],e[`size${f(n.size)}`],e[`${n.variant}Size${f(n.size)}`],n.color==="inherit"&&e.colorInherit,n.disableElevation&&e.disableElevation,n.fullWidth&&e.fullWidth,n.loading&&e.loading]}})(Tr(({theme:r})=>{const e=r.palette.mode==="light"?r.palette.grey[300]:r.palette.grey[800],n=r.palette.mode==="light"?r.palette.grey.A100:r.palette.grey[700];return{...r.typography.button,minWidth:64,padding:"6px 16px",border:0,borderRadius:(r.vars||r).shape.borderRadius,transition:r.transitions.create(["background-color","box-shadow","border-color","color"],{duration:r.transitions.duration.short}),"&:hover":{textDecoration:"none"},[`&.${G.disabled}`]:{color:(r.vars||r).palette.action.disabled},variants:[{props:{variant:"contained"},style:{color:"var(--variant-containedColor)",backgroundColor:"var(--variant-containedBg)",boxShadow:(r.vars||r).shadows[2],"&:hover":{boxShadow:(r.vars||r).shadows[4],"@media (hover: none)":{boxShadow:(r.vars||r).shadows[2]}},"&:active":{boxShadow:(r.vars||r).shadows[8]},[`&.${G.focusVisible}`]:{boxShadow:(r.vars||r).shadows[6]},[`&.${G.disabled}`]:{color:(r.vars||r).palette.action.disabled,boxShadow:(r.vars||r).shadows[0],backgroundColor:(r.vars||r).palette.action.disabledBackground}}},{props:{variant:"outlined"},style:{padding:"5px 15px",border:"1px solid currentColor",borderColor:"var(--variant-outlinedBorder, currentColor)",backgroundColor:"var(--variant-outlinedBg)",color:"var(--variant-outlinedColor)",[`&.${G.disabled}`]:{border:`1px solid ${(r.vars||r).palette.action.disabledBackground}`}}},{props:{variant:"text"},style:{padding:"6px 8px",color:"var(--variant-textColor)",backgroundColor:"var(--variant-textBg)"}},...Object.entries(r.palette).filter(nr()).map(([o])=>({props:{color:o},style:{"--variant-textColor":(r.vars||r).palette[o].main,"--variant-outlinedColor":(r.vars||r).palette[o].main,"--variant-outlinedBorder":r.alpha((r.vars||r).palette[o].main,.5),"--variant-containedColor":(r.vars||r).palette[o].contrastText,"--variant-containedBg":(r.vars||r).palette[o].main,"@media (hover: hover)":{"&:hover":{"--variant-containedBg":(r.vars||r).palette[o].dark,"--variant-textBg":r.alpha((r.vars||r).palette[o].main,(r.vars||r).palette.action.hoverOpacity),"--variant-outlinedBorder":(r.vars||r).palette[o].main,"--variant-outlinedBg":r.alpha((r.vars||r).palette[o].main,(r.vars||r).palette.action.hoverOpacity)}}}})),{props:{color:"inherit"},style:{color:"inherit",borderColor:"currentColor","--variant-containedBg":r.vars?r.vars.palette.Button.inheritContainedBg:e,"@media (hover: hover)":{"&:hover":{"--variant-containedBg":r.vars?r.vars.palette.Button.inheritContainedHoverBg:n,"--variant-textBg":r.alpha((r.vars||r).palette.text.primary,(r.vars||r).palette.action.hoverOpacity),"--variant-outlinedBg":r.alpha((r.vars||r).palette.text.primary,(r.vars||r).palette.action.hoverOpacity)}}}},{props:{size:"small",variant:"text"},style:{padding:"4px 5px",fontSize:r.typography.pxToRem(13)}},{props:{size:"large",variant:"text"},style:{padding:"8px 11px",fontSize:r.typography.pxToRem(15)}},{props:{size:"small",variant:"outlined"},style:{padding:"3px 9px",fontSize:r.typography.pxToRem(13)}},{props:{size:"large",variant:"outlined"},style:{padding:"7px 21px",fontSize:r.typography.pxToRem(15)}},{props:{size:"small",variant:"contained"},style:{padding:"4px 10px",fontSize:r.typography.pxToRem(13)}},{props:{size:"large",variant:"contained"},style:{padding:"8px 22px",fontSize:r.typography.pxToRem(15)}},{props:{disableElevation:!0},style:{boxShadow:"none","&:hover":{boxShadow:"none"},[`&.${G.focusVisible}`]:{boxShadow:"none"},"&:active":{boxShadow:"none"},[`&.${G.disabled}`]:{boxShadow:"none"}}},{props:{fullWidth:!0},style:{width:"100%"}},{props:{loadingPosition:"center"},style:{transition:r.transitions.create(["background-color","box-shadow","border-color"],{duration:r.transitions.duration.short}),[`&.${G.loading}`]:{color:"transparent"}}}]}})),He=N("span",{name:"MuiButton",slot:"StartIcon",overridesResolver:(r,e)=>{const{ownerState:n}=r;return[e.startIcon,n.loading&&e.startIconLoadingStart,e[`iconSize${f(n.size)}`]]}})(({theme:r})=>({display:"inherit",marginRight:8,marginLeft:-4,variants:[{props:{size:"small"},style:{marginLeft:-2}},{props:{loadingPosition:"start",loading:!0},style:{transition:r.transitions.create(["opacity"],{duration:r.transitions.duration.short}),opacity:0}},{props:{loadingPosition:"start",loading:!0,fullWidth:!0},style:{marginRight:-8}},...Dr]})),Qe=N("span",{name:"MuiButton",slot:"EndIcon",overridesResolver:(r,e)=>{const{ownerState:n}=r;return[e.endIcon,n.loading&&e.endIconLoadingEnd,e[`iconSize${f(n.size)}`]]}})(({theme:r})=>({display:"inherit",marginRight:-4,marginLeft:8,variants:[{props:{size:"small"},style:{marginRight:-2}},{props:{loadingPosition:"end",loading:!0},style:{transition:r.transitions.create(["opacity"],{duration:r.transitions.duration.short}),opacity:0}},{props:{loadingPosition:"end",loading:!0,fullWidth:!0},style:{marginLeft:-8}},...Dr]})),Ke=N("span",{name:"MuiButton",slot:"LoadingIndicator"})(({theme:r})=>({display:"none",position:"absolute",visibility:"visible",variants:[{props:{loading:!0},style:{display:"flex"}},{props:{loadingPosition:"start"},style:{left:14}},{props:{loadingPosition:"start",size:"small"},style:{left:10}},{props:{variant:"text",loadingPosition:"start"},style:{left:6}},{props:{loadingPosition:"center"},style:{left:"50%",transform:"translate(-50%)",color:(r.vars||r).palette.action.disabled}},{props:{loadingPosition:"end"},style:{right:14}},{props:{loadingPosition:"end",size:"small"},style:{right:10}},{props:{variant:"text",loadingPosition:"end"},style:{right:6}},{props:{loadingPosition:"start",fullWidth:!0},style:{position:"relative",left:-10}},{props:{loadingPosition:"end",fullWidth:!0},style:{position:"relative",right:-10}}]})),dr=N("span",{name:"MuiButton",slot:"LoadingIconPlaceholder"})({display:"inline-block",width:"1em",height:"1em"}),Ye=b.forwardRef(function(e,n){const o=b.useContext(Wr),t=b.useContext(_r),a=$r(o,e),m=ar({props:a,name:"MuiButton"}),{children:u,color:d="primary",component:s="button",className:i,disabled:l=!1,disableElevation:p=!1,disableFocusRipple:k=!1,endIcon:h,focusVisibleClassName:w,fullWidth:z=!1,id:C,loading:y=null,loadingIndicator:L,loadingPosition:M="center",size:$="medium",startIcon:B,type:S,variant:A="text",...P}=m,H=ee(C),j=L??g.jsx(te,{"aria-labelledby":H,color:"inherit",size:16}),I={...m,color:d,component:s,disabled:l,disableElevation:p,disableFocusRipple:k,fullWidth:z,loading:y,loadingIndicator:j,loadingPosition:M,size:$,type:S,variant:A},E=Ve(I),X=(B||y&&M==="start")&&g.jsx(He,{className:E.startIcon,ownerState:I,children:B||g.jsx(dr,{className:E.loadingIconPlaceholder,ownerState:I})}),Z=(h||y&&M==="end")&&g.jsx(Qe,{className:E.endIcon,ownerState:I,children:h||g.jsx(dr,{className:E.loadingIconPlaceholder,ownerState:I})}),rr=t||"",Q=typeof y=="boolean"?g.jsx("span",{className:E.loadingWrapper,style:{display:"contents"},children:y&&g.jsx(Ke,{className:E.loadingIndicator,ownerState:I,children:j})}):null;return g.jsxs(Ue,{ownerState:I,className:K(o.className,E.root,i,rr),component:s,disabled:l||y,focusRipple:!k,focusVisibleClassName:K(E.focusVisible,w),ref:n,type:S,id:y?H:C,...P,classes:E,children:[X,M!=="end"&&Q,u,M==="end"&&Q,Z]})});function Je(r){return b.Children.toArray(r).filter(e=>b.isValidElement(e))}function Xe(r){return tr("MuiButtonGroup",r)}const c=Nr("MuiButtonGroup",["root","contained","outlined","text","disableElevation","disabled","firstButton","fullWidth","horizontal","vertical","colorPrimary","colorSecondary","grouped","groupedHorizontal","groupedVertical","groupedText","groupedTextHorizontal","groupedTextVertical","groupedTextPrimary","groupedTextSecondary","groupedOutlined","groupedOutlinedHorizontal","groupedOutlinedVertical","groupedOutlinedPrimary","groupedOutlinedSecondary","groupedContained","groupedContainedHorizontal","groupedContainedVertical","groupedContainedPrimary","groupedContainedSecondary","lastButton","middleButton"]),Ze=(r,e)=>{const{ownerState:n}=r;return[{[`& .${c.grouped}`]:e.grouped},{[`& .${c.grouped}`]:e[`grouped${f(n.orientation)}`]},{[`& .${c.grouped}`]:e[`grouped${f(n.variant)}`]},{[`& .${c.grouped}`]:e[`grouped${f(n.variant)}${f(n.orientation)}`]},{[`& .${c.grouped}`]:e[`grouped${f(n.variant)}${f(n.color)}`]},{[`& .${c.firstButton}`]:e.firstButton},{[`& .${c.lastButton}`]:e.lastButton},{[`& .${c.middleButton}`]:e.middleButton},e.root,e[n.variant],n.disableElevation===!0&&e.disableElevation,n.fullWidth&&e.fullWidth,n.orientation==="vertical"&&e.vertical]},rn=r=>{const{classes:e,color:n,disabled:o,disableElevation:t,fullWidth:a,orientation:m,variant:u}=r,d={root:["root",u,m,a&&"fullWidth",t&&"disableElevation",`color${f(n)}`],grouped:["grouped",`grouped${f(m)}`,`grouped${f(u)}`,`grouped${f(u)}${f(m)}`,`grouped${f(u)}${f(n)}`,o&&"disabled"],firstButton:["firstButton"],lastButton:["lastButton"],middleButton:["middleButton"]};return or(d,Xe,e)},en=N("div",{name:"MuiButtonGroup",slot:"Root",overridesResolver:Ze})(Tr(({theme:r})=>({display:"inline-flex",borderRadius:(r.vars||r).shape.borderRadius,variants:[{props:{variant:"contained"},style:{boxShadow:(r.vars||r).shadows[2]}},{props:{disableElevation:!0},style:{boxShadow:"none"}},{props:{fullWidth:!0},style:{width:"100%"}},{props:{orientation:"vertical"},style:{flexDirection:"column",[`& .${c.lastButton},& .${c.middleButton}`]:{borderTopRightRadius:0,borderTopLeftRadius:0},[`& .${c.firstButton},& .${c.middleButton}`]:{borderBottomRightRadius:0,borderBottomLeftRadius:0}}},{props:{orientation:"horizontal"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderTopRightRadius:0,borderBottomRightRadius:0},[`& .${c.lastButton},& .${c.middleButton}`]:{borderTopLeftRadius:0,borderBottomLeftRadius:0}}},{props:{variant:"text",orientation:"horizontal"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderRight:r.vars?`1px solid ${r.alpha(r.vars.palette.common.onBackground,.23)}`:`1px solid ${r.palette.mode==="light"?"rgba(0, 0, 0, 0.23)":"rgba(255, 255, 255, 0.23)"}`,[`&.${c.disabled}`]:{borderRight:`1px solid ${(r.vars||r).palette.action.disabled}`}}}},{props:{variant:"text",orientation:"vertical"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderBottom:r.vars?`1px solid ${r.alpha(r.vars.palette.common.onBackground,.23)}`:`1px solid ${r.palette.mode==="light"?"rgba(0, 0, 0, 0.23)":"rgba(255, 255, 255, 0.23)"}`,[`&.${c.disabled}`]:{borderBottom:`1px solid ${(r.vars||r).palette.action.disabled}`}}}},...Object.entries(r.palette).filter(nr()).flatMap(([e])=>[{props:{variant:"text",color:e},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderColor:r.alpha((r.vars||r).palette[e].main,.5)}}}]),{props:{variant:"outlined",orientation:"horizontal"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderRightColor:"transparent","&:hover":{borderRightColor:"currentColor"}},[`& .${c.lastButton},& .${c.middleButton}`]:{marginLeft:-1}}},{props:{variant:"outlined",orientation:"vertical"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderBottomColor:"transparent","&:hover":{borderBottomColor:"currentColor"}},[`& .${c.lastButton},& .${c.middleButton}`]:{marginTop:-1}}},{props:{variant:"contained",orientation:"horizontal"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderRight:`1px solid ${(r.vars||r).palette.grey[400]}`,[`&.${c.disabled}`]:{borderRight:`1px solid ${(r.vars||r).palette.action.disabled}`}}}},{props:{variant:"contained",orientation:"vertical"},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderBottom:`1px solid ${(r.vars||r).palette.grey[400]}`,[`&.${c.disabled}`]:{borderBottom:`1px solid ${(r.vars||r).palette.action.disabled}`}}}},...Object.entries(r.palette).filter(nr(["dark"])).map(([e])=>({props:{variant:"contained",color:e},style:{[`& .${c.firstButton},& .${c.middleButton}`]:{borderColor:(r.vars||r).palette[e].dark}}}))],[`& .${c.grouped}`]:{minWidth:40,boxShadow:"none",props:{variant:"contained"},style:{"&:hover":{boxShadow:"none"}}}}))),nn=b.forwardRef(function(e,n){const o=ar({props:e,name:"MuiButtonGroup"}),{children:t,className:a,color:m="primary",component:u="div",disabled:d=!1,disableElevation:s=!1,disableFocusRipple:i=!1,disableRipple:l=!1,fullWidth:p=!1,orientation:k="horizontal",size:h="medium",variant:w="outlined",...z}=o,C={...o,color:m,component:u,disabled:d,disableElevation:s,disableFocusRipple:i,disableRipple:l,fullWidth:p,orientation:k,size:h,variant:w},y=rn(C),L=b.useMemo(()=>({className:y.grouped,color:m,disabled:d,disableElevation:s,disableFocusRipple:i,disableRipple:l,fullWidth:p,size:h,variant:w}),[m,d,s,i,l,p,h,w,y.grouped]),M=Je(t),$=M.length,B=S=>{const A=S===0,P=S===$-1;return A&&P?"":A?y.firstButton:P?y.lastButton:y.middleButton};return g.jsx(en,{as:u,role:"group",className:K(y.root,a),ref:n,ownerState:C,...z,children:g.jsx(Wr.Provider,{value:L,children:M.map((S,A)=>g.jsx(_r.Provider,{value:B(A),children:S},A))})})}),on=_e({createStyledComponent:N("div",{name:"MuiGrid",slot:"Root",overridesResolver:(r,e)=>{const{ownerState:n}=r;return[e.root,n.container&&e.container]}}),componentName:"MuiGrid",useThemeProps:r=>ar({props:r,name:"MuiGrid"}),useTheme:ae});function tn({disabledSearch:r,onClose:e,onOpen:n}){const[o,t]=b.useState(!1),a=b.useCallback(()=>{r||(t(!0),n?.())},[r,n]),m=b.useCallback((u,d)=>{!d&&u&&e?.(u),t(!1)},[e]);return{isActive:o,showMenu:a,closeMenu:m}}function mr(r,e){if(r.inserted[e.name]===void 0)return r.insert("",e,r.sheet,!0)}function ur(r,e,n){var o=[],t=Or(r,o,n);return o.length<2?n:t+e(o)}var an=function(e){var n=ie(e);n.sheet.speedy=function(u){this.isSpeedy=u},n.compat=!0;var o=function(){for(var d=arguments.length,s=new Array(d),i=0;i<d;i++)s[i]=arguments[i];var l=er(s,n.registered,void 0);return se(n,l,!1),n.key+"-"+l.name},t=function(){for(var d=arguments.length,s=new Array(d),i=0;i<d;i++)s[i]=arguments[i];var l=er(s,n.registered),p="animation-"+l.name;return mr(n,{name:l.name,styles:"@keyframes "+p+"{"+l.styles+"}"}),p},a=function(){for(var d=arguments.length,s=new Array(d),i=0;i<d;i++)s[i]=arguments[i];var l=er(s,n.registered);mr(n,l)},m=function(){for(var d=arguments.length,s=new Array(d),i=0;i<d;i++)s[i]=arguments[i];return ur(n.registered,o,sn(s))};return{css:o,cx:m,injectGlobal:a,keyframes:t,hydrate:function(d){d.forEach(function(s){n.inserted[s]=!0})},flush:function(){n.registered={},n.inserted={},n.sheet.flush()},sheet:n.sheet,cache:n,getRegisteredStyles:Or.bind(null,n.registered),merge:ur.bind(null,n.registered,o)}},sn=function r(e){for(var n="",o=0;o<e.length;o++){var t=e[o];if(t!=null){var a=void 0;switch(typeof t){case"boolean":break;case"object":{if(Array.isArray(t))a=r(t);else{a="";for(var m in t)t[m]&&m&&(a&&(a+=" "),a+=m)}break}default:a=t}a&&(n&&(n+=" "),n+=a)}}return n},ln=an({key:"css"}),x=ln.css,pr=Object.freeze,cn=Object.defineProperty,v=(r,e)=>pr(cn(r,"raw",{value:pr(r.slice())}));function dn(r,e){r.classList.add(e)}var gr,Vr=x(gr||(gr=v([`
  /**
...
`]))),Rr;x(Rr||(Rr=v([`
  ...
  `,`
  `,`
`])),Vr,Ur,mn,un,pn,gn,hn,bn,fn,kn,yn,xn,vn,wn,zn,Sn,Cn,An,Mn);const Bn=x`
	${Vr}
	${Ur}
`;function Hr({className:r}){const e=b.useRef(null),{getRootProps:n}=le();return b.useEffect(()=>{e.current&&dn(e.current,Bn)},[]),g.jsx("div",{...n({ref:e}),className:r})}Hr.__docgenInfo={description:`A custom version of the EditorComponent exposed by Remirror
but uses a ref so to style the element without CSS file imports
Fix for carrot-vscode-extension - CSS file imports don't work`,methods:[],displayName:"SearchEditorComponent",props:{className:{required:!1,tsType:{name:"string"},description:""}}};function En(r){const e=b.useRef(null),n=b.useRef(0);return ce(r,e.current)||(e.current=r,n.current+=1),[n.current]}function jn(r){return Object.values(r).reduce((e,n)=>({...e,...n.extraAttributes}),{})}function In(r){const e=r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(?!${e})[\\w\\d_]+`)}function Pn(r,e){return Object.values(r).map(o=>{const{name:t}=o;return{name:t,char:`${t}:`,matchOffset:0,unicode:!0,mentionClassName:e,supportedCharacters:In(`${t}:`)}})}function Rn(r){const e=jn(r.fields);return[new de,new me({emptyNodeClass:r.emptyNodeClass,placeholder:r.placeholder}),new ue({extraAttributes:e,matchers:[...Pn(r.fields,r.mentionClass)],invalidMarks:["mention"],isValidPosition:(o,t)=>{const{to:a}=t.range;return a===o.$cursor.doc.content.size-1}})]}function Ln(r){return b.useMemo(()=>()=>Rn(r),En([r]))}function $n(r){const{getContext:e,initialContent:n}=r;b.useEffect(()=>{const o=e();if(!o)return;const t=n||qr;o.setContent(t,{triggerChange:!0})},[n,e])}const Gn=Fr()(r=>({emptyNode:{"&:first-of-type::before":{position:"absolute",color:r.palette.text.secondary,pointerEvents:"none",height:0,content:"attr(data-placeholder)"}},mentionClass:{color:r.palette.action.active},editor:{maxHeight:r.spacing(3),color:r.palette.text.primary,outline:"none",cursor:"text",width:"100%",overflow:"hidden !important","& p":{lineHeight:r.spacing(3),margin:0,caretColor:r.palette.primary.main,cursor:"pointer"}}}));function Qr({innerRef:r,initialSearchQuery:e,fields:n,onBlur:o,onFocus:t,onSubmit:a,placeholder:m,children:u,disabledSearch:d}){const{classes:s}=Gn(),[i,l]=b.useState(qr),p=Ln({fields:n,placeholder:m,emptyNodeClass:s.emptyNode,mentionClass:s.mentionClass});b.useEffect(()=>{(async()=>{const y=await be({searchQuery:e,fields:n});l(y)})()},[n,e]);const{manager:k,state:h,onChange:w,getContext:z}=pe({extensions:p,content:i});return $n({initialContent:i,getContext:z}),g.jsxs(ge,{manager:k,initialContent:h,classNames:[s.editor],onFocus:t,onBlur:o,onChange:w,editable:!d,children:[g.jsx(he,{ref:r,onSubmit:a}),u]})}Qr.__docgenInfo={description:"",methods:[],displayName:"SearchEditorProvider",props:{placeholder:{required:!1,tsType:{name:"string"},description:""},initialSearchQuery:{required:!1,tsType:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]},description:""},disabledSearch:{required:!1,tsType:{name:"boolean"},description:""},isActive:{required:!1,tsType:{name:"boolean"},description:""},fields:{required:!0,tsType:{name:"Record",elements:[{name:"string"},{name:"Field"}],raw:"Record<string, Field>"},description:""},innerRef:{required:!1,tsType:{name:"ReactRefObject",raw:"React.RefObject<SearchImperativeRef | null>",elements:[{name:"union",raw:"SearchImperativeRef | null",elements:[{name:"SearchImperativeRef"},{name:"null"}]}]},description:""},onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(doc: ProsemirrorNode) => void",signature:{arguments:[{type:{name:"ProsemirrorNode"},name:"doc"}],return:{name:"void"}}},description:""},onFocus:{required:!1,tsType:{name:"signature",type:"function",raw:"(params: RemirrorEventListenerProps<AnyExtension>) => boolean",signature:{arguments:[{type:{name:"RemirrorEventListenerProps",elements:[{name:"AnyExtension"}],raw:"RemirrorEventListenerProps<AnyExtension>"},name:"params"}],return:{name:"boolean"}}},description:""},onBlur:{required:!1,tsType:{name:"signature",type:"function",raw:`(
	params: RemirrorEventListenerProps<AnyExtension>,
	event: Event,
) => boolean`,signature:{arguments:[{type:{name:"RemirrorEventListenerProps",elements:[{name:"AnyExtension"}],raw:"RemirrorEventListenerProps<AnyExtension>"},name:"params"},{type:{name:"Event"},name:"event"}],return:{name:"boolean"}}},description:""},children:{required:!0,tsType:{name:"ReactElement",elements:[{name:"HTMLElement"}],raw:"ReactElement<HTMLElement>"},description:""}}};const Nn=Fr()(r=>({root:{position:"relative",minHeight:r.spacing(5),width:"100%",zIndex:5},container:{position:"absolute",top:0,width:"100%",borderRadius:r.shape.borderRadius,border:`${r.spacing(.125)} solid ${r.palette.divider}`,background:r.palette.background.default},activeContainer:{boxShadow:r.palette.background.default},editorInputRoot:{display:"flex",flexDirection:"row",alignItems:"center",gap:r.spacing(.5),alignSelf:"stretch",paddingRight:r.spacing(.625),maxHeight:r.spacing(3)},editorWrapper:{display:"flex",alignItems:"flex-start",alignContent:"center",gap:r.spacing(.75),flex:"1 0 0",flexWrap:"wrap",width:"100%",overflow:"hidden"},searchBox:{padding:r.spacing(1)},footer:{padding:r.spacing(2),width:"100%",borderTop:`${r.spacing(.125)} solid ${r.palette.divider}`}}));function ir({disabledSearch:r,onSubmit:e,fields:n,classes:o,innerRef:t,initialSearchQuery:a,placeholder:m,menuFooter:u,fixedFooter:d,preventOnBlurSearch:s,getSuggestions:i}){const{classes:l,cx:p}=Nn(),k=b.useCallback(B=>{const S=fe({doc:B});e?.(S)},[n,e]),{isActive:h,closeMenu:w,showMenu:z}=tn({onClose:k,disabledSearch:r}),C=b.useCallback(()=>(z(),!0),[z]),y=b.useRef(null),L=b.useCallback((B,S)=>{const{doc:A}=B.view.state,P=S.relatedTarget;return!A||y.current===null||y.current.contains(P)?(S.preventDefault(),!1):(w(B.view.state.doc,s),!0)},[w,s,y]),M=b.useMemo(()=>p(l.container,o?.container,{[p(l.activeContainer,o?.activeContainer)]:h}),[l.activeContainer,l.container,o?.activeContainer,o?.container,p,h]),$=h&&u;return g.jsx(Qr,{onFocus:C,onBlur:L,onSubmit:k,fields:n,innerRef:t,disabledSearch:r,initialSearchQuery:a,placeholder:m,isActive:h,children:g.jsx("div",{ref:y,className:p(l.root,o?.root),children:g.jsxs("div",{className:M,children:[g.jsx("div",{className:p(l.searchBox,o?.searchBox),children:g.jsx("div",{className:l.editorInputRoot,children:g.jsx(Hr,{className:l.editorWrapper})})}),g.jsx(ke,{fields:n,isActive:h,closeMenu:w,getSuggestions:i,optionLabel:"search",selectLabel:"select"}),$&&g.jsx("div",{className:l.footer,children:u}),d&&g.jsx("div",{className:l.footer,children:d})]})})})}ir.__docgenInfo={description:"",methods:[],displayName:"SearchEditor",props:{onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(searchQuery: string) => void",signature:{arguments:[{type:{name:"string"},name:"searchQuery"}],return:{name:"void"}}},description:""},classes:{required:!1,tsType:{name:"signature",type:"object",raw:`{
	root?: string;
	container?: string;
	...
	searchedTerm?: string;
	input?: string;
}`,signature:{properties:[{key:"searchedTerm",value:{name:"string",required:!1}},{key:"input",value:{name:"string",required:!1}}]}},name:"props"}],return:{name:"Promise",elements:[{name:"Array",elements:[{name:"NamedMentionExtensionAttributes"}],raw:"NamedMentionExtensionAttributes[]"}],raw:"Promise<NamedMentionExtensionAttributes[]>"}}},description:""}},composes:["Omit"]};const{action:Lr}=__STORYBOOK_MODULE_ACTIONS__,Wn={title:"Editors / Search Editor",component:ir},Kr=`list:item1,item2,item3 creator:${we[0].id} tag:${ze[0].id}`,U=r=>{const{renderUser:e,renderTag:n,renderDate:o,dateOptions:t,tagOptions:a,userOptions:m}=ye(),u=async l=>{Lr("getSuggestions")(l);const{input:p}=l,k=[...t,...a,...m];if(!p)return[];const h=p.toLowerCase();return k.filter(z=>z.label.toLowerCase().includes(h))},d=b.useRef(null),s=l=>async p=>l.find(k=>k.id===p),i={tag:{getExtraAttrs:s(a),type:"keyword",name:"tag",render:n,fieldIcon:g.jsx(ve,{})},date:{getExtraAttrs:s(t),type:"range",name:"date",render:o,fieldIcon:g.jsx(lr,{})},creator:{getExtraAttrs:s(m),type:"keyword",name:"creator",render:e,fieldIcon:g.jsx(lr,{})}};return g.jsxs(on,{direction:"row",container:!0,gap:1,alignContent:"center",alignItems:"center",children:[g.jsx(ir,{placeholder:"Search by tags or users",fields:i,innerRef:d,onSubmit:Lr("onSubmit"),getSuggestions:u,...r}),g.jsx(nn,{children:g.jsx(Ye,{variant:"contained",onClick:()=>d.current?.clearContent(),children:"Clear content"})})]})},q=U.bind({});q.args={};const F=U.bind({});F.args={initialSearchQuery:Kr};const W=U.bind({});W.args={initialSearchQuery:Kr,disabledSearch:!0};const _=U.bind({});_.args={fixedFooter:g.jsx("div",{style:{textAlign:"center"},children:"Fixed Footer"})};const D=U.bind({});D.args={menuFooter:g.jsx("div",{style:{textAlign:"center"},children:"Menu Footer"})};const V=()=>g.jsx(xe,{isLoadingSuggestions:!0,options:[],renderOption:()=>null,renderSelectOption:()=>null,getItemProps:()=>({}),indexIsHovered:()=>!1,indexIsSelected:()=>!1,getMenuProps:()=>({}),optionLabel:"",selectLabel:""});V.__docgenInfo={description:"",methods:[],displayName:"Loading"};q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`(props: SearchEditorStoryArgs) => {
  const {
    renderUser,
    renderTag,
    renderDate,
...
}`,...q.parameters?.docs?.source}}};F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`(props: SearchEditorStoryArgs) => {
  const {
    renderUser,
    renderTag,
    renderDate,
...
}`,...F.parameters?.docs?.source}}};W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`(props: SearchEditorStoryArgs) => {
  const {
    renderUser,
    renderTag,
    renderDate,
...
}`,...W.parameters?.docs?.source}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`(props: SearchEditorStoryArgs) => {
  const {
    renderUser,
    renderTag,
    renderDate,
...
}`,..._.parameters?.docs?.source}}};D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`(props: SearchEditorStoryArgs) => {
  const {
    renderUser,
    renderTag,
    renderDate,
...
}`,...V.parameters?.docs?.source}}};const _n=["Basic","Filled","Disabled","FixedFooter","MenuFooter","Loading"];export{q as Basic,W as Disabled,F as Filled,_ as FixedFooter,V as Loading,D as MenuFooter,_n as __namedExportsOrder,Wn as default};
